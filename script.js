...
targetElement1.addEventListener('mouseenter', (event) => {
    // Afficher le conteneur
...
targetElement2.addEventListener('mouseenter', (event) => {
    // Afficher le conteneur
...
targetElement3.addEventListener('mouseenter', (event) => {
    // Afficher le conteneur
...
targetElement4.addEventListener('mouseenter', (event) => {
    // Afficher le conteneur
...
targetElement5.addEventListener('mouseenter', (event) => {
    // Afficher le conteneur
...
targetElement6.addEventListener('mouseenter', (event) => {
    // Afficher le conteneur
...
targetElement7.addEventListener('mouseenter', (event) => {
    // Afficher le conteneur
